            ...
            <nav className="limiter-menu-desktop container">
              ...
              <div className="menu-desktop">
                <ul className="main-menu">
                  ...
                  <li
                    className={router.pathname == `/about` ? `active-menu` : ``}
                  >
                    <Link href="/about">
                      <a>About</a>
                    </Link>
              ...
              <div className="wrap-icon-header flex-w flex-r-m h-full">
                <div className="flex-c-m h-full p-r-24">
                  <div
                    ...
                    onClick={() => {
                      document
                        .querySelector(`.modal-search-header`)
                        ?.classList.add(`show-modal-search`);
          ...
          <div className="container-search-header">
            <button
              ...
              onClick={() => {
                document
                  .querySelector(`.modal-search-header`)
                  ?.classList.remove(`show-modal-search`);
                {
                  !router.query.q? (router.push(`/${router.pathname}`)) : (router.push(`/search?q=${router.query.q}`))
                }
